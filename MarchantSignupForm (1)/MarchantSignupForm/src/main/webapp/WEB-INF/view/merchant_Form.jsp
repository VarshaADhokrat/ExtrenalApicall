									...
									<div class="row mt-2">
										<div
											...
											<div class="form-group mb-0">
												<button id="editButton" type="button" class="btn btn-secondary editBtn">
													Edit
												</button>
											</div>
											<div class="form-group mb-0">
												<button id="nextButton" type="button" class="btn btn-secondary nextBtn">
													Next
												</button>
												</button>
											</div>
								...
								<div class="tab-pane">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12 d-flex align-middle justify-content-end formBtnSection">
                                            ...
                                            <div class="form-group mb-0">
                                                <button type="button" class="btn btn-secondary nextBtn">
                                                    Next
                                                </button>
                                            </div>
                                        </div>
             ...
             // Function to validate PERSONAL PAN card number
                        ...
                        function validatePanCardAndShowMessage(data) {
                            ...
                            .catch(error => {
                                ...
                                console.error('There was a problem with the PAN card validation:', error);
                            });
                        }
                        ...
                        personalPanInput.addEventListener('input', function () {
                            if (this.value.length === 10) {
                                ...
                                // If the input length is not 10, clear any previous messages
           ...
           //BUSINESS PAN VALIDATION
             ...
             function validateBusinessPanCardAndShowMessage(data) {
                fetchAccessToken()
                    ...
                    .then(data => {
                     if (data.success) {
                             panSuccess1.textContent = 'Pan Card verified successfully';
                             panError1.textContent = ''; // Clear any previous error messages
                        } else {
                             panSuccess1.textContent = ''; // Clear any previous success messages
                             panError1.textContent = 'Pan Card not verified';
                        }
                    })
                    .catch(error => {
                       // Handle errors, and log to console for debugging
                          panSuccess1.textContent = ''; // Clear any previous success messages
                          panError1.textContent = 'Invalid pan card number';
